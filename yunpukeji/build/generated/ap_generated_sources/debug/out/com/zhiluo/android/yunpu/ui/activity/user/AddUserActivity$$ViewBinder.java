...
public class AddUserActivity$$ViewBinder<T extends com.zhiluo.android.yunpu.ui.activity.user.AddUserActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131298278, "field 'tvSave'");
    target.tvSave = finder.castView(view, 2131298278, "field 'tvSave'");
    ...
    view = finder.findRequiredView(source, 2131296771, "field 'etName'");
    target.etName = finder.castView(view, 2131296771, "field 'etName'");
    view = finder.findRequiredView(source, 2131296773, "field 'etPaw'");
    target.etPaw = finder.castView(view, 2131296773, "field 'etPaw'");
    view = finder.findRequiredView(source, 2131296774, "field 'etPhone'");
    target.etPhone = finder.castView(view, 2131296774, "field 'etPhone'");
    view = finder.findRequiredView(source, 2131296775, "field 'etRemark'");
    target.etRemark = finder.castView(view, 2131296775, "field 'etRemark'");
