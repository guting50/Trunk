...
public class GoodsOrderAdapter extends BaseAdapter {
    Context context;
    GoodsOrderReportBean reportBean;

    public GoodsOrderAdapter(Context context, GoodsOrderReportBean reportBean) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        GoodsOrderReportBean.DataBean.DataListBean bean = reportBean.getData().getDataList().get(i);
