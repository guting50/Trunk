...
public class MoneyDetailAdapter extends BaseAdapter {
    Context context;
    MoneyDetailReportBean reportBean;

    public MoneyDetailAdapter(Context context, MoneyDetailReportBean reportBean) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        MoneyDetailReportBean.DataBean.DataListBean bean = reportBean.getData().getDataList().get(i);
