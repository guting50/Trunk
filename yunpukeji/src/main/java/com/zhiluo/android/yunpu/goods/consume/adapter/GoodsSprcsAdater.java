...
public class GoodsSprcsAdater extends BaseAdapter implements View.OnClickListener{

    private Context mContext;
    private List<GoodsCheckResponseByType.DataBean.DataListBean> mDataList;
    private ItemViewClick mItemViewClick;

    public GoodsSprcsAdater(Context mContext, List<GoodsCheckResponseByType.DataBean.DataListBean> mDataList,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.item_goods_specs, null);
