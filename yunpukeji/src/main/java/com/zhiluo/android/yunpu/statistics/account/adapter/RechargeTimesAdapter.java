...
public class RechargeTimesAdapter extends BaseAdapter {
    Context context;
    RechargeTimesReportBean reportBean;

    public RechargeTimesAdapter(Context context, RechargeTimesReportBean reportBean) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        RechargeTimesReportBean.DataBean.DataListBean bean = reportBean.getData().getDataList().get(i);
        ...
        holder.tvOrder.setText(bean.getMC_Order());
        if (bean.getVIP_Name()!=null){
            holder.tvName.setText(bean.getVIP_Name());
        }else {
            holder.tvName.setText(bean.getVCH_Card());
        }
        holder.tvValue1Name.setText("充次总额：");
        holder.tvValue2Name.setText("折后金额：");
        holder.tvValue1.setText(bean.getMC_Amount()+"");
        holder.tvValue2.setText(bean.getMC_AmountDis()+"");
        return view;
    }
