...
public class BluetoothService
{
    ...
    private void addUnbondDevicesToListView()
    {
        ...
        this.unbondDevicesListView.setOnItemClickListener(new OnItemClickListener()
        {
                                    ...
                                    int arg2, long arg3)
            {
                ...
                {
                    CustomToast.makeText(context, "配对失败！", Toast.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    public static String getMadress()
    {
        return madress;
    }
    public static void setMadress(String madress)
    {
        BluetoothService.madress = madress;
    }
}