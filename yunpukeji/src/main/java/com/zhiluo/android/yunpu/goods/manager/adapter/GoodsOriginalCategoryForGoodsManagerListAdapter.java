 ...
 */
public class GoodsOriginalCategoryForGoodsManagerListAdapter extends BaseAdapter
{
    private Context context;
    List<ProductTypeBean.DataBean> list;
    private int selectedPosition = -1;
    int itmposition = -1;

    public GoodsOriginalCategoryForGoodsManagerListAdapter(Context context, List<ProductTypeBean.DataBean> list)
    {
