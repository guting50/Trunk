...
public class RechargeScreenActivity extends BaseActivity {
    private ImageView mIvScan;
    private EditText mEtByMember, mEtByOrder, mEtXiaoYu, mEtDaYu;
    ...
    private void initView() {
        ...
        spStore = (Spinner) findViewById(R.id.sp_recharge_money_store);
    }
    ...
    private void initVariable() {
        ...
        mSpinnerAdapter = new ArrayAdapter<String>(RechargeScreenActivity.this,
                R.layout.item_spinner, R.id.tv_item_spinner, mStoreList);
        spStore.setAdapter(mSpinnerAdapter);
        spStore.setSelection(pos, true);
