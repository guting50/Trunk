...
public class NewManyChooseAdapter extends RecyclerView.Adapter<NewManyChooseAdapter.MyHolder> {
    ...
    public NewManyChooseAdapter(Context mContext, List<List<GoodsModelBean>> modelList, String manyStr, final InterfaceBack back) {
        this.mContext = mContext;
        this.modelList = modelList;
        this.mBack = back;
        if (manyStr.equals("many")) {
            isMany = true;
        }
    }
