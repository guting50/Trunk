...
public class AnalysisMemberAdapter extends BaseAdapter {
    private Context context;
    private List<MemberAnalysisBean.DataBean.MberListBean> list;

    public AnalysisMemberAdapter(Context context, List<MemberAnalysisBean.DataBean.MberListBean> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.tvName.setText(list.get(i).getVIP_Name() == null ? "" : list.get(i).getVIP_Name());
